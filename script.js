...
document.getElementById("start-countdown").addEventListener("click", function () {
    const inputDate = document.getElementById("newyear-input").value;
    ...
    newyearDate = new Date(inputDate + "T14:03:00").getTime();
...
function updateCountdown() {
    ...
    if (timeLeft <= 0) {
        // Newyear has passed
        countdownElement.innerHTML = "<h2>HAPPY NEW YEAR!</h2>";
